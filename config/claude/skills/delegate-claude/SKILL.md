...
- **SendMessage を進捗確認や催促に使わない**: 委任先は別プロセスだが同じマシン上の Claude Code セッションなので、ListAgents に現れ SendMessage も届く。届くからといって、状況を尋ねる・急かす・作業中に細かく口を出すために使ってはならない。委任先は対話しながら進める相手ではない。送ってよいのは「委任元が渡した前提が誤っていた場合の訂正」だけで、手順は後述の「委任後に前提の誤りが判明した場合」に従う
...
- **ゴールが変わるのか変わらないのか**: 最も重要。「作業内容は変わらないが理由付けだけが変わる」のか「ゴール自体が変わる」のかを明言しないと、委任先は作業をやり直すべきか判断できない
