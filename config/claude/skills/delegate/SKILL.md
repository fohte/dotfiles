...
連絡してよい条件、完了報告に含めるもの、送信手順は `scripts/prompt-template.md` が委任先のプロンプトに注入する。委任先はそれに従う。

委任先から連絡が来るのは、前提の誤りが判明したときと、direct-commit モードで push まで終えたときだけ。通常の委任では成果物の PR が残るため、完了報告は来ない。
