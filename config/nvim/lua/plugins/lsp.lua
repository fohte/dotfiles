...
return {
  {
    ...
    commit = '9e25c98d4826998460926f8c5c2284848d80ae89', -- renovate: branch=main
    config = function()
      require('mason').setup()
    end,
  },
  {
    ...
    commit = '844d247d998c2f9a6a3baad8bb9748edc55ce69f', -- renovate: branch=main
    dependencies = {
      { 'williamboman/mason.nvim' },
  ...
  {
    'neovim/nvim-lspconfig',
    commit = 'd0dbf489a8810672fa9a61f4a86e5cf89214b772', -- renovate: branch=master
    keys = {
      {
        '<F10>',
        function()
