return {
  {
    ...
    dependencies = {
      ...
      { 'hrsh7th/cmp-path', commit = 'e52e640b7befd8113b3350f46e8cfcfe98fcf730' }, -- renovate: branch=main
      {
        'petertriho/cmp-git',
      ...
      { 'onsails/lspkind.nvim', commit = 'd79a1c3299ad0ef94e255d045bed9fa26025dab6' }, -- renovate: branch=master
      { 'saadparwaiz1/cmp_luasnip', commit = '98d9cb5c2c38532bd9bdb481067b20fea8f32e90' }, -- renovate: branch=master
      {
        ...
        dependencies = {
          { 'zbirenbaum/copilot.lua', commit = '4958fb9390f624cb389be2772e3c5e718e94d8b6' }, -- renovate: branch=master
        },
        config = function()
